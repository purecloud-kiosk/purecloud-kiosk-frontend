...
export default class Events extends Component {
  	...
  	componentDidMount(){
  		if(eventsStore.updateIsSet()){
   		...
   		this.setState(state);
   		this.state.eventsStoreListener = eventsStore.addListener(eventsConstants.IMAGE_THUMB_STORED, this.handleImageThumbUploadedSuccessfully.bind(this, 'thumbCropper'));
		this.state.eventsStoreListener = eventsStore.addListener(eventsConstants.IMAGE_URL_STORED, this.handleImageUrlUploadedSuccessfully.bind(this, 'bannerCropper'));
